...
round(avg(purchase_amount),2) as avg_spend,round(sum(purchase_amount),2) as total_reve from 
customer group by subscription_status order by total_revenue,avg_spend desc
